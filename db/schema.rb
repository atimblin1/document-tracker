...
ActiveRecord::Schema[7.1].define(version: 2026_02_01_053715) do
  ...
  create_table "collection_items", force: :cascade do |t|
    ...
    t.index ["collection_id", "document_id"], name: "index_collection_items_on_collection_id_and_document_id", unique: true
    t.index ["collection_id", "position"], name: "index_collection_items_on_collection_id_and_position"
    t.index ["collection_id"], name: "index_collection_items_on_collection_id"
    t.index ["document_id"], name: "index_collection_items_on_document_id"
  end
  ...
  add_foreign_key "collection_items", "documents"
